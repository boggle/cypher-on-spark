...
class EmbeddedEntityTest extends BaseTestSuite {
  ...
  ignore("Refuses to use the same slot multiple times when constructing nodes") {
  ...
  // TODO: Fix exception handling
  ignore("Refuses to use the same slot multiple times when constructing relationships") {
