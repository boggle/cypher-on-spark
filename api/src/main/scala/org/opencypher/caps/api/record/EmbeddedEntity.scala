...
import org.opencypher.caps.api.global.{Label, PropertyKey}
...
sealed trait EmbeddedEntity extends Verifiable {
  ...
  private def duplicateEmbeddedEntityColumn(slot: String) =
    // TODO: Replace with Raise
    throw new IllegalStateException(s"Duplicate embedded entity column $slot")
}
