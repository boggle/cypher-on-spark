...
case object CypherValue extends CypherValueCompanion[CypherValue] {
  ...
  protected[value] def computeOrderability(l: CypherValue, r: CypherValue): Int = {
    ...
    if (cmp == 0)
      (l, r) match {
        ...
        case _ =>
          throw new IllegalArgumentException("Call to computeOrderability with values of different types")
      }
    else
      cmp
  }
  ...
  override protected[value] def computeComparability(l: CypherValue, r: CypherValue): Int = (l, r) match {
    ...
    case _ =>
      throw new IllegalArgumentException("Call to computeComparability with values of different types")
  }
}
