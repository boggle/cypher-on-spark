...
import org.opencypher.caps.api.global.{ConstantRef, ConstantRegistry, GlobalsRegistry, TokenRegistry}
...
import org.opencypher.caps.impl.convert.{IRBuilder, IRBuilderContext}
import org.opencypher.caps.impl.flat.{FlatPlanner, FlatPlannerContext}
import org.opencypher.caps.impl.global.GlobalsExtractor
