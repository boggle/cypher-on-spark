 ...
 */
package org.opencypher.caps.api.spark.record

import org.apache.spark.sql.types.{StructField, StructType}
import org.opencypher.caps.api.expr.Var
import org.opencypher.caps.api.record.{OpaqueField, RecordHeader, RecordSlot, RecordSlotColumnName}
...
object CAPSRecordHeader {
  ...
  private def structField(slot: RecordSlot, nullable: Boolean): StructField = {
    val name = RecordSlotColumnName.of(slot.content)
